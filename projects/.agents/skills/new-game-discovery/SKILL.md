...
description: First skill to use when the user wants to make, start, create, or prototype a new board game from an idea, theme, genre, mechanic, or component concept; guide the idea with focused questions before proposing rules, components, or files.
