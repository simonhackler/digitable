<script lang="ts">
	...
	const showChrome = $derived(!authRoutes.includes($page.url.pathname));
...
{#if showChrome}
	<header class="pt-6 pb-3">
		<div
			class="mx-auto grid max-w-[1440px] items-center justify-items-center gap-6 px-6 xl:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] xl:justify-items-stretch xl:gap-10"
		>
			<a
				href={resolve('/')}
				class="flex items-center gap-3.5 xl:justify-start"
			...
			<nav
				class="flex w-full flex-wrap items-center justify-center gap-3 rounded-full bg-white/70 px-3 py-2 shadow-[0_14px_28px_rgba(21,21,21,0.08),inset_0_0_0_1px_rgba(32,32,36,0.08)] backdrop-blur md:w-auto md:flex-nowrap xl:justify-self-center"
				aria-label="Primary"
			>
				<Button
					href={resolve('/blog')}
			...
			<div
				class="grid justify-items-center gap-3 sm:flex sm:flex-wrap sm:items-center sm:justify-center xl:flex-nowrap xl:justify-end xl:justify-self-end"
			>
				<div
					class="inline-flex items-center justify-center divide-x divide-black/10 overflow-hidden rounded-full bg-white/70 shadow-[0_14px_28px_rgba(21,21,21,0.08),inset_0_0_0_1px_rgba(32,32,36,0.08)] xl:justify-end"
				>
					<a
						href={discordUrl}
						class="group inline-flex h-10 w-11 items-center justify-center transition hover:bg-white"
					...
					<a
						href={githubUrl}
						class="group inline-flex h-10 items-center gap-2 px-3.5 text-sm font-semibold text-[#1c1c20] transition hover:bg-white hover:text-[#0d0d0f]"
