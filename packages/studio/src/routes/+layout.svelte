...
{#if showChrome}
	<header class="sticky top-0 z-50 border-b border-black/5 bg-white/85 py-3 backdrop-blur">
			...
			<div class="grid gap-4 md:hidden">
				<div class="flex items-center justify-between gap-3">
					...
					>
						<img
							src={mascot}
							alt=""
							class="h-10 w-10 shrink-0 rounded-[14px] object-cover shadow-[0_12px_24px_rgba(17,17,17,0.18)]"
						/>
					...
					<div class="flex items-center gap-2">
						...
						<Button
							...
							variant="outline"
							size="icon"
							class="h-10 w-10 rounded-full bg-white/80 shadow-[0_14px_28px_rgba(21,21,21,0.08)]"
				...
				{#if mobileMenuOpen}
					<nav
						...
						class="grid gap-1 rounded-[28px] bg-white/95 p-3 shadow-[0_20px_40px_rgba(21,21,21,0.12),inset_0_0_0_1px_rgba(32,32,36,0.08)] backdrop-blur"
						aria-label="Primary"
					>
						{#each primaryLinks as link (link.href)}
							<Button
								...
								variant="nav"
								size="unset"
								class="w-full justify-start rounded-2xl px-4 py-3 text-base"
			...
			<div class="hidden items-center gap-8 md:grid md:grid-cols-[auto_1fr_auto]">
				<div class="flex items-center gap-6">
					<a href={resolve('/')} class="flex items-center gap-3.5" aria-label="Digitable home">
						<img
							src={mascot}
							alt=""
							class="h-10 w-10 rounded-[14px] object-cover shadow-[0_12px_24px_rgba(17,17,17,0.18)]"
						/>
				...
				<div class="flex items-center justify-end gap-2">
					...
					<a
						...
						target="_blank"
					>
						<svg viewBox="0 0 256 199" class="h-5 w-5" aria-hidden="true">
							<path
								fill="currentColor"
								d="M216.856 16.597A208.502 208.502 0 0 0 164.042 0c-2.275 4.113-4.856 9.602-6.681 13.904a192.286 192.286 0 0 0-57.722 0C97.814 9.602 95.208 4.113 92.908 0a207.5 207.5 0 0 0-52.81 16.597C6.337 67.332-2.741 117.336.718 166.658a208.09 208.09 0 0 0 62.63 32.272c5.042-6.906 9.546-14.279 13.65-21.95a134.93 134.93 0 0 1-21.56-10.31c1.814-1.324 3.58-2.684 5.303-4.08c41.438 19.431 86.51 19.431 127.34 0c1.723 1.396 3.489 2.756 5.303 4.08a134.67 134.67 0 0 1-21.56 10.31c4.104 7.67 8.608 15.043 13.65 21.95a208.041 208.041 0 0 0 62.63-32.272c4.015-56.733-6.15-106.374-38.053-150.06ZM85.474 135.635c-12.645 0-23.021-11.468-23.021-25.608c0-14.14 10.18-25.608 23.021-25.608c12.84 0 23.216 11.468 23.021 25.608c0 14.14-10.18 25.608-23.021 25.608Zm85.064 0c-12.645 0-23.021-11.468-23.021-25.608c0-14.14 10.18-25.608 23.021-25.608c12.84 0 23.216 11.468 23.021 25.608c0 14.14-10.18 25.608-23.021 25.608Z"
							/>
