...
<header class="pt-6 pb-3">
		<div class="mx-auto max-w-[1120px] px-4 sm:px-6">
			<div class="grid gap-4 md:hidden">
				<div class="flex items-center justify-between gap-3">
					<a href={resolve('/')} class="flex min-w-0 items-center gap-3" aria-label="Digitable home">
						<img
							src={mascot}
							alt=""
			...
			{#if mobileMenuOpen}
				<nav
					...
					class="grid gap-1 rounded-[28px] bg-white/90 p-3 shadow-[0_20px_40px_rgba(21,21,21,0.12),inset_0_0_0_1px_rgba(32,32,36,0.08)] backdrop-blur"
					aria-label="Primary"
				>
		...
		<div
			class="hidden items-center justify-items-center gap-6 md:grid md:grid-cols-[1fr_auto_1fr] md:justify-items-stretch"
		>
				<a
					href={resolve('/')}
				...
				>
					<img
						src={mascot}
						alt=""
						class="h-11 w-11 rounded-[14px] object-cover shadow-[0_12px_24px_rgba(17,17,17,0.18)]"
					/>
